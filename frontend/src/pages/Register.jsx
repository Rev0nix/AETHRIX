  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-16">
      <div className="bg-base-900 border border-white/10 p-10 w-full max-w-sm">
        <h1 className="font-display text-4xl tracking-wider mb-2">JOIN</h1>
        <p className="text-sm text-white/35 mb-8">Create your AETHRIX account.</p>
        ...
        <p className="text-center text-sm text-white/30 mt-6">
          Already have an account? <Link to="/login" className="text-accent-glow">Sign in →</Link>
        </p>
      </div>
    </div>
  );
